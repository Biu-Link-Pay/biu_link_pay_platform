...
const maskedEmail = computed(() => {
  if (!userProfile.value?.userEmail)
    return 'sh****@example.com'
...
// Navigation methods
async function navigateToGoogleAuth() {
...
function onUnbindCodeInput(event: Event) {
  const target = event.target as HTMLInputElement
  const value = target.value.replace(/\D/g, '') // Digits only
...
<template>
            ...
            <div class="flex items-center space-x-6">
              ...
              <div class="flex-1">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                  {{ userProfile?.firstName || t('personalCenter.user') }}
                </h2>
                <div class="space-y-3">
                  <!-- Email -->
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                      <i v-if="kycStatus === 1" class="pi pi-check text-green-500" />
                      <i v-else-if="kycStatus === 2" class="pi pi-exclamation-triangle text-yellow-500" />
                      <i v-else-if="kycStatus === 3" class="pi pi-times text-red-500" />
                      <i v-else class="pi pi-clock text-gray-500" />
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                  <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center">
                    <i class="pi pi-google text-blue-600 dark:text-blue-400 text-lg" />
                  </div>
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white">
                      {{ t('personalCenter.googleAuth') }}
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                      {{ t('personalCenter.googleAuthDesc') }}
                    </p>
                  </div>
                </div>
                <div class="flex items-center space-x-2">
            ...
            <!-- <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer"
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white">{{ t('personalCenter.language') }}</h3>
            ...
            >
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                  ...
                  >
                    <i class="pi pi-file text-purple-600 dark:text-purple-400 text-lg" />
                  </div>
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white">
                      {{ t('personalCenter.termsOfService') }}
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                      {{ t('personalCenter.termsDesc') }}
                    </p>
                  </div>
                </div>
                <i class="pi pi-chevron-right text-gray-400" />
            ...
            >
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                  ...
                  >
                    <i class="pi pi-shield text-indigo-600 dark:text-indigo-400 text-lg" />
                  </div>
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white">
                      {{ t('personalCenter.privacyPolicy') }}
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                      {{ t('personalCenter.privacyDesc') }}
                    </p>
                  </div>
                </div>
                <i class="pi pi-chevron-right text-gray-400" />
            ...
            >
              <div class="flex items-center justify-between gap-4">
                <div class="flex items-center space-x-4">
                  ...
                  >
                    <i class="pi pi-link text-amber-600 dark:text-amber-400 text-lg" />
                  </div>
                  <div class="flex-1 min-w-0">
                    <h3 class="font-semibold text-gray-900 dark:text-white">
                      {{ t('personalCenter.invitationLink') }}
                    </h3>
                ...
                <button
                  ...
                  :disabled="!hasInviteLink" :title="t('personalCenter.copyInviteLink')" @click="copyInviteLink"
                >
            ...
            <!-- <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer"
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white">{{ t('personalCenter.safetyValidation') }}</h3>
            ...
            <!-- <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow cursor-pointer"
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 class="font-semibold text-gray-900 dark:text-white">{{ t('personalCenter.referralCode') }}</h3>
            ...
            >
              <div class="flex items-center justify-center space-x-4">
                <div class="w-12 h-12 bg-red-100 dark:bg-red-900/20 rounded-lg flex items-center justify-center">
                  <i class="pi pi-sign-out text-red-600 dark:text-red-400 text-lg" />
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
          <div class="flex items-center space-x-4 mb-4">
            <div class="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center">
              <i class="pi pi-user text-white text-xl" />
            </div>
            <div>
        ...
        <div class="space-y-2">
          ...
          >
            <div class="flex items-center space-x-3">
              <div class="w-10 h-10 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center">
                <i class="pi pi-google text-blue-600 dark:text-blue-400" />
              </div>
          ...
          <!-- <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700 flex items-center justify-between cursor-pointer"
            ...
            <div class="flex items-center space-x-3">
              ...
              <span class="font-medium text-gray-900 dark:text-white">{{ t('personalCenter.language') }}</span>
            </div>
            <div class="flex items-center space-x-2">
              <span class="text-sm text-gray-600 dark:text-gray-400">EN-US</span>
              <i class="pi pi-chevron-right text-gray-400"></i>
          ...
          >
            <div class="flex items-center space-x-3">
              <div class="w-10 h-10 bg-purple-100 dark:bg-purple-900/20 rounded-lg flex items-center justify-center">
                <i class="pi pi-file text-purple-600 dark:text-purple-400" />
              </div>
              <span class="font-medium text-gray-900 dark:text-white">{{ t('personalCenter.termsOfService') }}</span>
            </div>
            <i class="pi pi-chevron-right text-gray-400" />
          </div>
          ...
          >
            <div class="flex items-center space-x-3">
              ...
              <span class="font-medium text-gray-900 dark:text-white">{{ t('personalCenter.privacyPolicy') }}</span>
            </div>
            <i class="pi pi-chevron-right text-gray-400" />
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-3">
                ...
                >
                  <i class="pi pi-link text-amber-600 dark:text-amber-400" />
                </div>
                <div class="flex-1">
          ...
          <!-- <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700 flex items-center justify-between cursor-pointer"
            ...
            <div class="flex items-center space-x-3">
              ...
              <span class="font-medium text-gray-900 dark:text-white">{{ t('personalCenter.safetyValidation') }}</span>
            </div>
            <i class="pi pi-chevron-right text-gray-400"></i>
          </div> -->
          ...
          <!-- <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-200 dark:border-gray-700 flex items-center justify-between cursor-pointer"
            ...
            <div class="flex items-center space-x-3">
              ...
              <span class="font-medium text-gray-900 dark:text-white">{{ t('personalCenter.referralCode') }}</span>
            </div>
            <i class="pi pi-chevron-right text-gray-400"></i>
          </div> -->
          ...
          >
            <div class="flex items-center space-x-3">
              <div class="w-10 h-10 bg-red-100 dark:bg-red-900/20 rounded-lg flex items-center justify-center">
                <i class="pi pi-sign-out text-red-600 dark:text-red-400" />
              </div>
              <span class="font-medium text-red-600 dark:text-red-400">{{ t('personalCenter.logOut') }}</span>
            </div>
            <i class="pi pi-chevron-right text-gray-400" />
          </div>
        </div>
  ...
  <Dialog
    v-model:visible="showGoogleAuthBindDialog" modal header="Bind Google Authenticator"
    ...
    <div class="space-y-6">
      ...
      <div class="text-center space-y-4">
        <div class="w-20 h-20 mx-auto bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center">
          <i class="pi pi-qrcode text-blue-600 dark:text-blue-400 text-3xl" />
        </div>
        <div>
        ...
        <div v-if="bindQrCode" class="flex justify-center">
          <img
            :src="`data:image/png;base64,${bindQrCode}`" alt="Google Auth QR Code"
      ...
      <div class="space-y-4">
        ...
        <div class="flex justify-center">
          <InputText
            v-model="bindAuthCode" :placeholder="t('personalCenter.enterCode')" maxlength="6"
      ...
      <div class="flex justify-between space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        <Button :label="t('common.cancel')" severity="secondary" :disabled="bindLoading" class="flex-1" @click="cancelBind" />
        <Button
          :label="t('common.confirm')" icon="pi pi-check" :loading="bindLoading"
          :disabled="!bindAuthCode || bindAuthCode.length !== 6" class="flex-1" @click="confirmBind"
        />
      </div>
    </div>
  </Dialog>
  ...
  <Dialog
    v-model:visible="showGoogleAuthUnbindDialog" modal :header="t('personalCenter.unbindGoogleAuth')"
  ...
  >
    <div class="space-y-6">
      ...
      <div class="text-center space-y-4">
        ...
        <div>
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
            {{ t('personalCenter.confirmUnbind') }}
          </h3>
      ...
      <div class="space-y-4">
        ...
        <div class="flex justify-center">
          <InputText
            v-model="unbindAuthCode" :placeholder="t('personalCenter.enterCode')" maxlength="6"
      ...
      <!-- Action Buttons -->
      <div class="flex justify-between space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        <Button :label="t('common.cancel')" severity="secondary" :disabled="unbindLoading" class="flex-1" @click="cancelUnbind" />
        <Button
          :label="t('common.confirm')" icon="pi pi-times" severity="danger" :loading="unbindLoading"
          :disabled="!unbindAuthCode || unbindAuthCode.length !== 6" class="flex-1" @click="handleUnbindGoogleAuth"
        />
      </div>
    </div>
  </Dialog>
