...
async function launchKycSDK(): Promise<void> {
  try {
    ...
    if (typeof window !== 'undefined' && (window as any).snsWebSdk) {
      const snsWebSdkInstance = (window as any).snsWebSdk.init(token, () => getNewAccessToken()).withConf({ lang: 'zh' }).withOptions({ addViewportTag: false, adaptIframeHeight: true }).on('idCheck.onStepCompleted', (payload: any) => {
      ...
      <div class="max-w-4xl mx-auto">
        ...
        >
          <div class="flex items-start">
            <i class="pi pi-info-circle text-blue-600 dark:text-blue-400 mt-1 mr-3" />
            <div>
        ...
        >
          <div class="flex items-start">
            <i class="pi pi-exclamation-triangle text-yellow-600 dark:text-yellow-400 mt-1 mr-3" />
            <div>
              <h3 class="font-semibold text-yellow-900 dark:text-yellow-100 mb-2">
                KYC Temporarily Rejected
              </h3>
        ...
        >
          <div class="flex items-start">
            <i class="pi pi-times-circle text-red-600 dark:text-red-400 mt-1 mr-3" />
            <div>
        ...
        <div v-if="isPolling" class="mt-4 text-center">
          <div class="inline-flex items-center px-4 py-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
            <i class="pi pi-spin pi-spinner text-blue-600 dark:text-blue-400 mr-2" />
