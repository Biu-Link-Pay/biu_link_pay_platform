    ...
    <div class="bg-white shadow-sm border border-black/5 rounded-[14px] w-full max-w-[360px] ml-auto">
      <div class="flex flex-row p-5 gap-5 items-start">
        ...
        <div class="flex items-center justify-center">
          <button
            type="button" class="appearance-none outline-none border-0 px-3 py-2 rounded-lg bg-gray-100 text-gray-700 text-[16px] leading-none cursor-pointer hover:bg-gray-200 active:scale-[0.98] transition"
            @click="dismiss"
          >
            Okay
          </button>
