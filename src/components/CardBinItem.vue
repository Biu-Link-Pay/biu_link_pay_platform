...
<template>
  ...
  >
      ...
      <div class="pt-2 border-t border-gray-100">
        <div class="flex items-center justify-between">
          ...
          <div class="flex space-x-1">
            ...
            >
              <i class="pi pi-home text-green-600 text-xs" />
            </div>
            <div
            ...
            >
              <i class="pi pi-calendar text-blue-600 text-xs" />
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Selected Overlay -->
    <div v-if="selected" class="absolute inset-0 bg-yellow-400/10 rounded-xl pointer-events-none" />
  </div>
</template>
